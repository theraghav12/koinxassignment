...
function Navbar() {
  ...
  return (
    <div className="lg:h-20 h-16 flex items-center justify-between shadow-[#1026490F]/10 shadow-md bg-white w-screen">
      {/* Logo Section */}
      <div>
      ...
      {isOpen && (
        <div className="lg:hidden absolute top-20 right-0 mt-2 mr-2 bg-white rounded-md shadow-md py-5">
          <div className="text-lg font-semibold text-[#0F1629] px-4 py-2">
            ...
            <div className="cursor-pointer mb-2">Resource Center</div>
            <div>
